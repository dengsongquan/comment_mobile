...
<!--        <template>-->
<!--          <van-dropdown-menu required :rules="[{required : true, message : '请选择部门名称'}]">-->
<!--            <van-dropdown-item  :title="departName" v-model="addForm.depid" :options="departArr"-->
<!--                               @change="getDepart(addForm.depid)">-->
<!--            </van-dropdown-item>-->
<!--          </van-dropdown-menu>-->
...
<!--      </van-cell>-->
      ...
      <div style="margin-top:10px;">
        ...
        <van-button block plain style="margin-top:10px;" @click="clearAll">
          重置
        </van-button>
      </div>
