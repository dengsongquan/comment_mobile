<template>
  <div>
      <van-form style="margin-top: 10px;" v-model="addForm" ref="addForm">
        ...
        <van-popup position="bottom" v-model="showName" :overlay="false" :get-container="getContainer" :style="{height : '72%'}">
          <van-picker
              :columns="nameCol"
              show-toolbar
        ...
        <div style="margin-top:10px;">
          ...
          <van-button block plain @click="clearAll('addForm')" style="margin-top:10px;">
            重置
          </van-button>
        </div>
      </van-form>
